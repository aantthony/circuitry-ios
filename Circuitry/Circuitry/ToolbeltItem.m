...
+ (NSArray *) all {
    ...
    if (_all) return _all;
    _all = @[
             [[ToolbeltItem alloc] initWithType:@"button"  level:1  image:[UIImage imageNamed:@"switch"]   name:@"Button" fullName:@"Switch Button" subtitle:@"Toggle button"],
      // [[ToolbeltItem alloc] initWithType:@"pbtn"    image:[UIImage imageNamed:@"pushbutton"] name:@"Button" subtitle:@"Push button"],
             [[ToolbeltItem alloc] initWithType:@"light"   level:1  image:[UIImage imageNamed:@"led"]      name:@"Light" fullName:@"Light" subtitle:@"Light Emitting Diode"],
